...
![npm bundle size (version)](https://img.shields.io/badge/version-0.0.1-darkblue)  ![npm bundle size (version)](https://img.shields.io/badge/language-c++-blue) 
## Overview
...
**Important Note:** 
When connecting to WiFi keep in mind that this project utilises the Wokwi environment , if you implement this on a bare-metal machine, use your own ssid and password.
